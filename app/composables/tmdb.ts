import type { Credits, Media, MediaType, PageResult, Person } from '#shared/types'
 ...
 */
export async function getMediaByGenre(media: string, genre: string, page = 1, sortBy = 'popularity.desc'): Promise<PageResult<Media>> {
